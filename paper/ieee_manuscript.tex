...
(ASR $\to$ \asrEarlyUnlearn{} within \earlyUnlearnSteps{} steps) but drags
benign accuracy to \benignAfterUnlearn{} (Fig.~\ref{fig:unlearn}): the removal
...
them. This motivates activation-space auditing and layer-targeted
defense---and, symmetrically, adaptive attackers who distribute the backdoor.
